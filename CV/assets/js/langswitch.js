class Langswitch {
    constructor() {
        this.switcher = {
            ...
            "about-text1": `<img src="./assets/img/About_photo.jpg" alt="Фото автора" class="author_photo">I'm 30 years old, working for The Embassy of Hungary, in consular section. For a long time I worked in spheres, crossed to visa information support, tried myself in different ways, searched and learned a lot of different information.`,
            ...
            "sertificates": "Study sertificates:",
            ...
            "ru": {
                ...
                "sertificates": "Учебные сертификаты:",
